...
function getData($p, $userId){
    date_default_timezone_set("Asia/Tehran");
    $date = date("Y-m-d");
    $time = date("H-i-s");
    $info_time = "https://hivaind.ir/export/ExportJson.php?id=".$userId."&input=time_date&dwn=17000&min=".$date."&max=".tomorrow($date);
    // $info_time_yesterday = "http://hivaind.ir/export/ExportJson.php?id=".$userId."&input=time_date&dwn=9000&min=".yesterday($date)."&max=".$date;
    echo "<script>console.log('".$info_time."')</script>";
    // echo "<script>console.log('".$info_time_yesterday."')</script>";
}
getData(1 , $userId);
...
<html lang="en">
    ...
    <body class="bg-color-dark">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 bg-color pb-2">
                <div class="d-flex justify-content-between">
                    <div class="d-flex justify-content-start">
                        ...
                        <div class="mt-2">
                            <select class="form-select  button bcbox text-light " aria-label="Default select example">
                                <option value="1" selected class="float-end">a day ago</option>
        ...
        <div class="d-none d-sm-none d-md-block">
            <div class="row justify-content-center fixed-bottom mb-1">
                <div class="col-12 col-sm-6 col-md-2 col-lg-2">
                    <div class="rounded-3 p-2 bg-color text-light">
                        <p>Count</p>
                        <p class="text-center fs-1" style="color:#fca500"><?php echo $dataCount;?></p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-2 col-lg-2">
                    <div class="rounded-3 p-2 bg-color text-light">
                ...
                <div class="col-5">
                    <div class="rounded-3 text-light">
                        <div class="d-flex fs-3">
                            <p>Count:</p>
                            <p class="text-center ms-2" style="color:#fca500"><?php echo $dataCount;?></p>
                        </div>
                    </div>
                </div>
                <div class="col-5">
