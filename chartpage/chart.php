...
if($inputjson != false){
    ...
    $info = json_decode(@file_get_contents("https://hivaind.ir/wil/informationID.php?id=" . $userId ));
    $cname = 'c'. substr($inputName, 5, 1);
    $calibre = 0;
    if(substr($inputName, 5,1) == 'A' or substr($inputName, 5,1) == 'B' or substr($inputName, 5,1) == 'C' or substr($inputName, 5,1) == 'D'){
        $calibre = intval($info->$cname);
    }
    $last = $input[0];
    $min = $last;
    $max = $last;
    ...
    if($time != null and $input != null) {
        ...
        for($i=0; $i < count($time); $i++){
            ...
            array_push($in,intval($input[$i])+$calibre);
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 bg-color pb-2">
                <div class="d-flex justify-content-between">
                    <div class="d-flex justify-content-start">
                        ...
                        <p class="text-light px-2 mt-3"><?php echo $deviceName;?></p>
